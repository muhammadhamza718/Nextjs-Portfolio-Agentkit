                ...
                >
                  ...
                  <div className="relative bg-linear-to-br from-zinc-900 via-zinc-900 to-zinc-950 dark:from-zinc-950 dark:via-black dark:to-zinc-950 border-2 border-yellow-600/40 p-8 flex flex-col min-h-[450px]">
                    ...
                    <div className="relative z-10 flex flex-col items-center text-center flex-1">
                      ...
                      {/* Logo Badge */}
                      {cert.logo && (
                        <div className="relative mb-6 flex items-center justify-center w-full px-8">
                          <div className="relative w-full h-16 flex items-center justify-center">
                            <div className="relative h-full w-full max-w-[200px] bg-white/5 rounded-lg border border-yellow-600/20 backdrop-blur-sm p-2 group-hover:bg-white/10 transition-colors duration-300">
                              <Image
